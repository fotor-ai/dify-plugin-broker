...
from tools.openapi.urls import FOTOR_OPENAPI_TASK_STATUS_URL, FOTOR_OPENAPI_REMBG_URL


class RembgTool(Tool):
    """
    Tool to remove background from image.
    """

    def _invoke(self, tool_parameters: dict[str, Any]) -> Generator[ToolInvokeMessage]:
        client = OpenAPIClient(
            api_key=self.runtime.credentials['fotor_openapi_key'],
            create_task_url=self.runtime.credentials['fotor_openapi_endpoint'] + FOTOR_OPENAPI_REMBG_URL,
        ...
        payload = {
            ...
            "action": tool_parameters.get("action", "auto"),
        }
