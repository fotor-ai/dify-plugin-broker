...
from tools.openapi.urls import FOTOR_OPENAPI_TASK_STATUS_URL, FOTOR_OPENAPI_FACESWAP_URL
...
class FaceswapTool(Tool):
    ...
    def _invoke(self, tool_parameters: dict[str, Any]) -> Generator[ToolInvokeMessage]:
        client = OpenAPIClient(
            ...
            create_task_url=self.runtime.credentials['fotor_openapi_endpoint'] + FOTOR_OPENAPI_FACESWAP_URL,
        ...
        payload = {
            ...
            "templateImageUrl": tool_parameters.get("templateImageUrl"),
        }
