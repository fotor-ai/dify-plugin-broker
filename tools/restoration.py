...
from tools.openapi.urls import FOTOR_OPENAPI_TASK_STATUS_URL, FOTOR_OPENAPI_RESTORATION_URL


class RestorationTool(Tool):
    """
    Tool to restore old image.
    """

    def _invoke(self, tool_parameters: dict[str, Any]) -> Generator[ToolInvokeMessage]:
        client = OpenAPIClient(
            api_key=self.runtime.credentials['fotor_openapi_key'],
            create_task_url=self.runtime.credentials['fotor_openapi_endpoint'] + FOTOR_OPENAPI_RESTORATION_URL,
        ...
        payload = {
            ...
            "faceUpsample": tool_parameters.get("faceUpsample", True),              # Use True by default
            "backgroundEnhance": tool_parameters.get("backgroundEnhance", True),    # Use True by default
            "upscale": tool_parameters.get("upscale", 1),                           # Use 1 by default
            "fidelityWeight": tool_parameters.get("fidelityWeight", 0.75),          # Use 0.75 by default
        }
