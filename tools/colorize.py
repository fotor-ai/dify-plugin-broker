...
from tools.openapi.urls import FOTOR_OPENAPI_TASK_STATUS_URL, FOTOR_OPENAPI_COLORIZE_URL


class ColorizeTool(Tool):
    """
    Tool to colorize black and white image.
    """

    def _invoke(self, tool_parameters: dict[str, Any]) -> Generator[ToolInvokeMessage]:
        client = OpenAPIClient(
            api_key=self.runtime.credentials['fotor_openapi_key'],
            create_task_url=self.runtime.credentials['fotor_openapi_endpoint'] + FOTOR_OPENAPI_COLORIZE_URL,
        ...
        payload = {
            ...
            "modelName": tool_parameters.get("modelName", "stable"),    # Use "stable" model by default
            "renderFactor": tool_parameters.get("renderFactor", 35),    # Use 35 by default
            "watermarked": tool_parameters.get("watermarked", False),   # Use False by default
        }
